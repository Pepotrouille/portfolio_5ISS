<template>
    ...
    <ul class="text-justify ml-10">
        <li><b>The sources of the energy</b> were first mentioned. 
    ...
    <ul class="text-justify ml-10">
        <li><b>Introduction to super capacitors</b>. 
            The aim of this introduction is to be able to know how a super capacitor works, and how to calculate the minimal input for the system to be working to choose and match the best capacity.
        ...
        <li><b>Characterization of an unknown capacitor</b>.
            ...
            The wire allowed us to overlook interferences that could confuse the measurements.
    ...
    <ul class="text-justify ml-10">
        <li><b>Application with wireless energy transmission</b>. 
            This last section was set to introduce us the difference between multiple antennas: Dipole, Yagi and Patch.
            We were able to see the modest amount of energy given by the wireless transmission, especially when the distance increased.
    ...
    <p class="text-justify my-5">
        ...
        However, harvesting requires specific environment depending on the way (thermal needs important difference of temperature, piezoelectric uses large vibration...)
